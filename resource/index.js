...
function displayItems(){
    ...
    var north=  document.getElementById('north-indian');
    ...
    const eggData= foodItem.filter((item)=>item.category=='egg');
    const chickenData= foodItem.filter((item)=>item.category=='chicken');
    const porkData= foodItem.filter((item)=>item.category=='pork');
    const beefData= foodItem.filter((item)=>item.category=='beef');
    const muttonData= foodItem.filter((item)=>item.category=='mutton');
    ...
    const northData= foodItem.filter((item)=>item.category=='north-indian');
    ...
    const dipsData= foodItem.filter((item)=>item.category=='dips');
